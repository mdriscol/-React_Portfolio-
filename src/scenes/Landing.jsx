      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-6xl font-playfair z-10 text-center md:text-start">
            KEARA {""}
            <span
              className="xs:relative xs:text-red xs:font-semibold z-20 xs:before:content-brush
          ...
          <p className="mt-20 mb-7 text-sm text-center md:text-start">
            Hello, my name is Keara. I have a great love for music and composing music.
            This website is to demonstrate my skills and to show my passion for music and art.
